...
export default function FAB() {
  return (
    <Link 
      ...
      className="fixed bottom-6 right-6 lg:bottom-8 lg:right-8 flex bg-[#25D366] text-white w-14 h-14 md:w-16 md:h-16 rounded-full shadow-2xl items-center justify-center hover:scale-110 active:scale-95 transition-all z-40 group border border-white/20 cursor-pointer"
    >
      <svg
